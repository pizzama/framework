...
Shader "BasePixlate"
{
	Properties
	{
		...
		[ASEEnd]_PixelsXY("PixelsXY", Range( 1 , 100)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				#else
				float2 staticSwitch15 = float2( 0,0 );
				#endif
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = tex2D( _MainTex, staticSwitch15 ).rgb;
				float Alpha = 1;
...
ASEEND*/
//CHKSM=62DA95323B855819534FD93AC29CD79ECC475734