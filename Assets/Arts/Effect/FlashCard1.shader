...
Shader "FlashCard1"
{
	Properties
	{
		...
		[ASEBegin]_TextureSample0("MainText", 2D) = "white" {}
		[ASEEnd]_ChangeColor("ChangeColor", Color) = (0.7264151,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float dotResult24 = dot( tex2D( _TextureSample0, uv_TextureSample0 ) , float4( float3(0.3,0.6,0.1) , 0.0 ) );
				float4 temp_cast_1 = (dotResult24).xxxx;
				float4 blendOpSrc26 = _ChangeColor;
				float4 blendOpDest26 = temp_cast_1;
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( saturate( 2.0f*blendOpDest26*blendOpSrc26 + blendOpDest26*blendOpDest26*(1.0f - 2.0f*blendOpSrc26) )).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=19002
579.2;93.6;1472.8;875;892.6446;622.2237;1.3;True;True
Node;AmplifyShaderEditor.ColorNode;25;-413.4,-306.7;Inherit;False;Property;_ChangeColor;ChangeColor;1;0;Create;True;0;0;0;False;0;False;0.7264151,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;10;-513.4,-100.3;Inherit;True;Property;_TextureSample0;MainText;0;0;Create;True;0;0;0;False;0;False;-1;a8be047fab9cabf4fb7329970e8d97eb;a8be047fab9cabf4fb7329970e8d97eb;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DotProductOpNode;24;-176.4,-36.70001;Inherit;False;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;22;-412.4,110.3;Inherit;False;Constant;_Vector0;Vector 0;1;0;Create;True;0;0;0;False;0;False;0.3,0.6,0.1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.BlendOpsNode;26;-21.30002,-165.4;Inherit;False;SoftLight;True;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;COLOR;0
...
ASEEND*/
//CHKSM=34DAA1FA93AE56B44ADEBC9453DD79AC872E0C9E