...
namespace UnityEngine.UI.Extensions
{
    ...
    public class RangeSlider : Selectable, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
    {
        ...
        [SerializeField]
        private RectTransform m_MiddleHandleRect;

        public RectTransform MiddleHandleRect { get { return m_MiddleHandleRect; } set { if (SetClass(ref m_MiddleHandleRect, value)) { UpdateCachedReferences(); UpdateVisuals(); } } }
        ...
        private Transform m_MiddleHandleTransform;
        private RectTransform m_MiddleHandleContainerRect;
        ...
        void UpdateCachedReferences()
        {
            ...
            if (m_MiddleHandleRect && m_MiddleHandleRect != (RectTransform)transform)
            {
                m_MiddleHandleTransform = m_MiddleHandleRect.transform;
                if (m_MiddleHandleTransform.parent != null)
                {
                    m_MiddleHandleContainerRect = m_MiddleHandleTransform.parent.GetComponent<RectTransform>();
                }
            }
            else
            {
                m_MiddleHandleRect = null;
                m_MiddleHandleContainerRect = null;
            }
        }
        ...
        private void UpdateVisuals()
        {
            ...
            if (m_MiddleHandleContainerRect != null)
            {
                Vector2 anchorMin = Vector2.zero;
                Vector2 anchorMax = Vector2.one;
                anchorMin[0] = anchorMax[0] = (NormalizedHighValue - NormalizedLowValue) * 0.5f + NormalizedLowValue;
                m_MiddleHandleRect.anchorMin = anchorMin;
                m_MiddleHandleRect.anchorMax = anchorMax;
            }
        }
