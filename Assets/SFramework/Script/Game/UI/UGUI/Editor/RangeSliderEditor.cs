...
namespace UnityEngine.UI.Extensions
{
    ...
    public class RangeSliderEditor : SelectableEditor
    {
        ...
        SerializedProperty m_MiddleHandleRect;
        ...
        protected override void OnEnable()
        {
            ...
            m_MiddleHandleRect = serializedObject.FindProperty("m_MiddleHandleRect");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_MiddleHandleRect);
            ...
            if (m_LowHandleRect.objectReferenceValue != null && m_HighHandleRect.objectReferenceValue != null)
            {
                ...
                //m_MiddleValue.floatValue = high - low;
