...
public class Transform2DProxy : MoveProxy<Transform>
{
    public override void MoveByTarget(Vector3 mousePosition)
    {
        ...
        if (movementVelocity != Vector3.zero)
        {
            ...
            playerControl.rotation = Quaternion.AngleAxis(angle - 90, Vector3.forward);
        }
    }
    ...
    public override void MoveByInput(float inputX, float inputY)
    {
        ...
        {
            movementVelocity.Set(inputX, inputY, 0);
            ...
            // 1.由于鱼的起始位置不是0，0 方向。需要先旋转 y -90度
            ...
            if (movementVelocity != Vector3.zero)
            {
                ...
                Quaternion toRatation = Quaternion.LookRotation(Vector3.forward, movementVelocity);
