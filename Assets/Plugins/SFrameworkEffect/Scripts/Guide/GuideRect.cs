...
public class GuideRect : GuideBase
{
 
    [SerializeField] protected float width;       // 镂空区域的宽
    [SerializeField] protected float height;      // 镂空区域的高

    [SerializeField] private float scaleWidth;    // 动态变化的宽
    [SerializeField] private float scaleHeight;   // 动态变化的高
