...
{	
	[CustomPropertyDrawer (typeof(SFInformationAttribute))]
	/// <summary>
	/// This class allows the display of a message box (warning, info, error...) next to a property (before or after)
	/// </summary>
	public class SFInformationAttributeDrawer : PropertyDrawer 
	{
        ...
        SFInformationAttribute informationAttribute { get { return ((SFInformationAttribute)attribute); } }
